...
export default function ContactPage() {
  return (
    <div className="h-screen flex flex-col md:flex-row items-center gap-4 justify-center transition-colors">
      <Image src="/img/form.gif" width={500} height={500} alt="img" />
      {/* Contact Form */}
      <div className="flex flex-col bg-white dark:bg-gray-900 dark:text-white p-8 rounded-lg shadow-lg w-full max-w-md mt-8 md:mt-0">
        <h2 className="text-3xl font-bold text-gradientStart dark:text-gradientEnd mb-4">
          Contact Us
        </h2>
